      ...
      <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3" style="margin-top: 10px;">
        <div class="col">
          <div class="card shadow-sm" style="background-color: #171717;">
            ...
            <div class="card-body" style="background-color: #171717;">
              <h5 class="card-text" style="color: #E0DDAA">Nebula yang Dapat Dilihat dengan kasat mata, <span style="color: #7D1E6A"><b>Nebula Orion.</b></span></h5>
        ...
        <div class="col">
          <div class="card shadow-sm" style="background-color: #171717;">
            ...
            <div class="card-body" style="background-color: #171717;">
              <h5 class="card-text" style="color: #E0DDAA">Sinarnya Dapat Terlihat Di Cahaya Ultraviolet, <span style="color: #7D1E6A"><b>Nebula Kupu-Kupu.</b></span></h5>
              <div class="d-flex justify-content-between align-items-center">
                <div class="btn-group">
                  <button type="button" class="btn btn-sm btn-outline-secondary" style="color: #E0DDAA">View</button>
                </div>
        ...
        <div class="col">
          <div class="card shadow-sm" style="background-color: #171717;">
            ...
            <div class="card-body" style="background-color: #171717;">
              <h5 class="card-text" style="color: #E0DDAA">Badannya yang Terbentang Hingga 55-70 Tahun Cahaya,<span style="color: #7D1E6A"><b> Nebula Elang.</b></span></h5>
              <div class="d-flex justify-content-between align-items-center">
                <div class="btn-group">
                  <button type="button" class="btn btn-sm btn-outline-secondary" style="color: #E0DDAA">View</button>
                </div>
        ...
        <div class="col">
          <div class="card shadow-sm" style="background-color: #171717;">
            ...
            <div class="card-body" style="background-color: #171717;">
              <h5 class="card-text" style="color: #E0DDAA">Nebula Hasil Dari Supernova Pada 1054, <span style="color: #7D1E6A"><b>Nebula Kepiting.</b></span></h5>
              <div class="d-flex justify-content-between align-items-center">
                <div class="btn-group">
                  <button type="button" class="btn btn-sm btn-outline-secondary" style="color: #E0DDAA">View</button>
                </div>
        ...
        <div class="col">
          <div class="card shadow-sm" style="background-color: #171717;">
            ...
            <div class="card-body" style="background-color: #171717;">
              <h5 class="card-text" style="color: #E0DDAA">Nebula Planeter Termuda di Selatan, <span style="color: #7D1E6A"><b>Nebula Jam Pasir.</b></span></h5>
              <div class="d-flex justify-content-between align-items-center">
                <div class="btn-group">
                  <button type="button" class="btn btn-sm btn-outline-secondary" style="color: #E0DDAA">View</button>
                </div>
        ...
        <div class="col">
          <div class="card shadow-sm" style="background-color: #171717;">
            ...
            <div class="card-body" style="background-color: #171717;">
              <h5 class="card-text" style="color: #E0DDAA">Nebula Dari Partikel-Partikel Gas dan Debu, <span style="color: #7D1E6A;"><b>Nebula Emisi.</b></span></h5>
                <div class="d-flex justify-content-between align-items-center">
              <div class="d-flex justify-content-between align-items-center">
                <div class="btn-group">
                  <button type="button" class="btn btn-sm btn-outline-secondary" style="color: #E0DDAA">View</button>
